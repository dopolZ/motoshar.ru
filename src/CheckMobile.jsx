         ...
         const home = { 
            section1: state ?
               <p>
                  ...
                  &bull; качественные фотографии всех узлов<br />
                  &bull; проверка дымности, шумности + видео запуска<br /><br />
               ...
               <>
                  ...
                  <span><b>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&bull;&ensp;качественные фотографии всех узлов</b></span>
                  <span><b>&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&bull;&ensp;видео запуска двигателя</b></span>
            ...
            section2: state ?
               <p>
                  Статистика собирает итоги предыдущих торгов<br />
                  c понятной ценой и частотой появления на аукционе<br /><br />
                  <b>&bull; меняйте фильтры для быстрого поиска<br />
                  &bull; сравнивайте цены по году выпуска<br />
                  &bull; выбирайте нужные оценки<br /><br />
                  Некогда? Оставьте заявку, мы всё сделаем!</b>
               </p>
               :
               <>
                  <span>&ensp;</span>
                  <span>Статистика накапливает итоги торгов, где можно найти любой мотоцикл</span>
            ...
            section3: state ?
               ...
               <>
                  ...
                  <span>&ensp;</span>
                  <span>Итоговая стоимость аукционного мотоцикла складывается из:</span>
            ...
            section5: state ?
               ...
               <>
                  ...
                  <span>&ensp;&ensp;&ensp;&ensp;приехать в пункт выдачи, оплатить услуги доставки и получить мотоцикл</span>
               </>,
